#!/usr/bin/env python3
"""
# credentials_default_switch_get.py
...
from nd_python.credentials.default_switch_get import CredentialsDefaultSwitchGet
...
def action() -> None:
    """
    Given a validated configuration, retrieve the default switch credentials.
    """
    # Prepopulate error message in case of failure
    errmsg = "Error retrieving default switch credentials. "
    try:
        instance = CredentialsDefaultSwitchGet()
    ...
    result_msg = "Default switch credentials:\n"
...
def setup_parser() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        ...
        description="DESCRIPTION: Retrieve default switch credentials from the controller.",
    )
