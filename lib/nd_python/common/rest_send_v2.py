...
class RestSend:
    ...
    -   A ResponseHandler() class is used in the usage example below that
        ...
        -   See ``common/response_handler.py`` for details
    ...
    def commit_normal_mode(self) -> None:
        """
        Call rest_send() with retries until successful response or timeout is exceeded.
    ...
    def response_handler(self, value: ResponseHandler) -> None:
        method_name = inspect.stack()[0][3]
