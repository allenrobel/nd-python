...
class Results:
    ...
    diff, response, and result dicts are per the Ansible NDFC Collection standard output.
    ...
    @changed.setter
    def changed(self, value: set[bool]) -> None:
        method_name = inspect.stack()[0][3]
    ...
    def diff_current(self) -> dict:
        ...
        """
        return self.properties["diff_current"]
    ...
    def metadata_current(self) -> dict:
        ...
        Return the current metadata which is comprised of the properties action,
    ...
    def response_data(self, value) -> None:
        if isinstance(value, dict):
            value = [copy.deepcopy(value)]
        self.properties["response_data"].extend(value)
    ...
    def result_current(self, value: dict) -> None:
        method_name = inspect.stack()[0][3]
        if not isinstance(value, dict):
            msg = f"{self.class_name}.{method_name}: "
